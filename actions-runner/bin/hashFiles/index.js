    ...
    /***/ 2627: /***/ function (
      ...
      function run() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
          ...
          try {
            for (
              var _d = true, _e = __asyncValues(globber.globGenerator()), _f;
          ...
          return __asyncGenerator(this, arguments, function* globGenerator_1() {
            ...
            while (stack.length) {
              ...
              if (stats.isDirectory()) {
                // Matched
                if (
                  match & internal_match_kind_1.MatchKind.Directory &&
      ...
      class Pattern {
        ...
        match(itemPath) {
          ...
          if (this.segments[this.segments.length - 1] === "**") {
            ...
            if (
              !itemPath.endsWith(path.sep) &&
              this.isImplicitPattern === false
            ) {
